...
/**
 * Tests {@link CsvIteratorConverter#PATTERN}.
 *
 * @since 2.9
...
public final class CsvConverterPatternTest {
    ...
    public void noConfig() {
        final Matcher matcher = CsvIteratorConverter.PATTERN.matcher("csv:file://test.csv");
    ...
    @Test
    public void invalid() {
        Asserts.assertDoesNotMatch(CsvIteratorConverter.PATTERN, "");
        Asserts.assertDoesNotMatch(CsvIteratorConverter.PATTERN, "csv");
        Asserts.assertDoesNotMatch(CsvIteratorConverter.PATTERN, "csv:");
        Asserts.assertDoesNotMatch(CsvIteratorConverter.PATTERN, "cvs:file://test.csv");
        Asserts.assertDoesNotMatch(CsvIteratorConverter.PATTERN, "csv::http://www.example.com/data.csv");
        Asserts.assertDoesNotMatch(CsvIteratorConverter.PATTERN, "test.csv");
        Asserts.assertDoesNotMatch(CsvIteratorConverter.PATTERN, ",:ftp://ftp.example.org/data.csv");
    }
