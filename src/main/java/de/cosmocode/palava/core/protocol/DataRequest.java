...
public final class DataRequest extends AbstractRequest {
    ...
    public DataRequest(RequestHeader header, InputStream stream) {
        super(header, stream);
    }
     ...
     * @throws IOException
     * @deprecated use {@link DataRequest#getArguments()} instead
     */
    @Deprecated
    ...
    private void parseArgs() throws ConnectionLostException, IOException {
        ...
        log.debug(getHeader().getJob() + " - Got args:  " + cb.toString());
